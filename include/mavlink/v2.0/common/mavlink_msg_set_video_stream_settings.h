...
typedef struct __mavlink_set_video_stream_settings_t {
 ...
 uint32_t bitrate; /*< [bits/s] Bit rate in bits per second (set to -1 for auto)*/
 uint16_t resolution_h; /*< [pix] Resolution horizontal in pixels (set to -1 for highest resolution possible)*/
 uint16_t resolution_v; /*< [pix] Resolution vertical in pixels (set to -1 for highest resolution possible)*/
 ...
 * @param framerate [Hz] Frames per second (set to -1 for highest framerate possible)
 * @param resolution_h [pix] Resolution horizontal in pixels (set to -1 for highest resolution possible)
 * @param resolution_v [pix] Resolution vertical in pixels (set to -1 for highest resolution possible)
 * @param bitrate [bits/s] Bit rate in bits per second (set to -1 for auto)
 ...
 *
 * @return [Hz] Frames per second (set to -1 for highest framerate possible)
 */
 ...
 *
 * @return [pix] Resolution horizontal in pixels (set to -1 for highest resolution possible)
 */
 ...
 *
 * @return [pix] Resolution vertical in pixels (set to -1 for highest resolution possible)
 */
 ...
 *
 * @return [bits/s] Bit rate in bits per second (set to -1 for auto)
 */
