...
static void mavlink_test_external_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_EXTERNAL_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_external_control_t packet_in = {
        93372036854775807ULL,{ 963497880, 963497881, 963497882, 963497883 },185.0,213.0,101,168,235,46,113
    };
    mavlink_external_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.demand_time_utc_msec = packet_in.demand_time_utc_msec;
        packet1.vertical_LOS = packet_in.vertical_LOS;
        packet1.azimuth_LOS = packet_in.azimuth_LOS;
        packet1.sys_id = packet_in.sys_id;
        packet1.order_seq = packet_in.order_seq;
        packet1.param_type = packet_in.param_type;
        packet1.control_mode = packet_in.control_mode;
        packet1.tmg_input_type = packet_in.tmg_input_type;
        
        mav_array_memcpy(packet1.param, packet_in.param, sizeof(uint32_t)*4);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_EXTERNAL_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_EXTERNAL_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_external_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_external_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_external_control_pack(system_id, component_id, &msg , packet1.demand_time_utc_msec , packet1.param , packet1.vertical_LOS , packet1.azimuth_LOS , packet1.sys_id , packet1.order_seq , packet1.param_type , packet1.control_mode , packet1.tmg_input_type );
    mavlink_msg_external_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_external_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.demand_time_utc_msec , packet1.param , packet1.vertical_LOS , packet1.azimuth_LOS , packet1.sys_id , packet1.order_seq , packet1.param_type , packet1.control_mode , packet1.tmg_input_type );
    mavlink_msg_external_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_external_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_external_control_send(MAVLINK_COMM_1 , packet1.demand_time_utc_msec , packet1.param , packet1.vertical_LOS , packet1.azimuth_LOS , packet1.sys_id , packet1.order_seq , packet1.param_type , packet1.control_mode , packet1.tmg_input_type );
    mavlink_msg_external_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("EXTERNAL_CONTROL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_EXTERNAL_CONTROL) != NULL);
#endif
}

static void mavlink_test_swarm_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SWARM_POSITION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_swarm_position_t packet_in = {
        93372036854775807ULL,93372036854776311ULL,93372036854776815ULL,185.0,213.0,241.0,963499336,963499544,963499752,353.0,381.0,409.0,437.0,465.0,493.0,221,32,99,166,233,44
    };
    mavlink_swarm_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.time_utc_diff = packet_in.time_utc_diff;
        packet1.last_wp_time = packet_in.last_wp_time;
        packet1.total_dist = packet_in.total_dist;
        packet1.turn_dist = packet_in.turn_dist;
        packet1.dist_curr = packet_in.dist_curr;
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        packet1.alt = packet_in.alt;
        ...
        packet1.true_airspd = packet_in.true_airspd;
        packet1.cog_rad = packet_in.cog_rad;
        packet1.vel_ned_valid = packet_in.vel_ned_valid;
        packet1.gen_wp_flag = packet_in.gen_wp_flag;
        packet1.sys_id = packet_in.sys_id;
        packet1.circle_mode = packet_in.circle_mode;
        packet1.position_type = packet_in.position_type;
        packet1.seq = packet_in.seq;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SWARM_POSITION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SWARM_POSITION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_swarm_position_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_swarm_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_swarm_position_pack(system_id, component_id, &msg , packet1.time_usec , packet1.time_utc_diff , packet1.last_wp_time , packet1.total_dist , packet1.turn_dist , packet1.dist_curr , packet1.lat , packet1.lon , packet1.alt , packet1.vel_m_s , packet1.vel_n_m_s , packet1.vel_e_m_s , packet1.vel_d_m_s , packet1.true_airspd , packet1.cog_rad , packet1.vel_ned_valid , packet1.gen_wp_flag , packet1.sys_id , packet1.circle_mode , packet1.position_type , packet1.seq );
    mavlink_msg_swarm_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_swarm_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.time_utc_diff , packet1.last_wp_time , packet1.total_dist , packet1.turn_dist , packet1.dist_curr , packet1.lat , packet1.lon , packet1.alt , packet1.vel_m_s , packet1.vel_n_m_s , packet1.vel_e_m_s , packet1.vel_d_m_s , packet1.true_airspd , packet1.cog_rad , packet1.vel_ned_valid , packet1.gen_wp_flag , packet1.sys_id , packet1.circle_mode , packet1.position_type , packet1.seq );
    mavlink_msg_swarm_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_swarm_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SWARM_POSITION") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SWARM_POSITION) != NULL);
#endif
}

static void mavlink_test_video_raw_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VIDEO_RAW_DATA >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_video_raw_data_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,963498712,963498920,963499128,963499336,963499544,963499752,19731,19835,19939,20043,20147,'G'
    };
    mavlink_video_raw_data_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_msec = packet_in.time_msec;
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        packet1.height = packet_in.height;
        ...
        packet1.v_e = packet_in.v_e;
        packet1.v_n = packet_in.v_n;
        packet1.v_u = packet_in.v_u;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VIDEO_RAW_DATA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VIDEO_RAW_DATA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_raw_data_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_video_raw_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_raw_data_pack(system_id, component_id, &msg , packet1.node_id , packet1.time_msec , packet1.lat , packet1.lon , packet1.height , packet1.roll_speed , packet1.pitch_speed , packet1.yaw_speed , packet1.roll , packet1.pitch , packet1.yaw , packet1.v_e , packet1.v_n , packet1.v_u , packet1.velocity , packet1.laser_distance , packet1.pitch_frame_angle , packet1.yaw_frame_angle );
    mavlink_msg_video_raw_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_raw_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.node_id , packet1.time_msec , packet1.lat , packet1.lon , packet1.height , packet1.roll_speed , packet1.pitch_speed , packet1.yaw_speed , packet1.roll , packet1.pitch , packet1.yaw , packet1.v_e , packet1.v_n , packet1.v_u , packet1.velocity , packet1.laser_distance , packet1.pitch_frame_angle , packet1.yaw_frame_angle );
    mavlink_msg_video_raw_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_video_raw_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_raw_data_send(MAVLINK_COMM_1 , packet1.node_id , packet1.time_msec , packet1.lat , packet1.lon , packet1.height , packet1.roll_speed , packet1.pitch_speed , packet1.yaw_speed , packet1.roll , packet1.pitch , packet1.yaw , packet1.v_e , packet1.v_n , packet1.v_u , packet1.velocity , packet1.laser_distance , packet1.pitch_frame_angle , packet1.yaw_frame_angle );
    mavlink_msg_video_raw_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("VIDEO_RAW_DATA") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_VIDEO_RAW_DATA) != NULL);
#endif
}

static void mavlink_test_visual_inertial_navigation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VISUAL_INERTIAL_NAVIGATION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_visual_inertial_navigation_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,963498712,963498920,963499128,963499336,963499544,963499752,963499960,963500168,963500376,963500584,963500792,963501000,963501208,963501416,963501624,21603,21707,21811,21915,22019,22123,22227,'U','V','W','X','Y'
    };
    mavlink_visual_inertial_navigation_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_msec = packet_in.time_msec;
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        ...
        packet1.ay = packet_in.ay;
        packet1.az = packet_in.az;
        packet1.lat_target = packet_in.lat_target;
        packet1.lon_target = packet_in.lon_target;
        packet1.height_target = packet_in.height_target;
        packet1.lat_plan = packet_in.lat_plan;
        packet1.lon_plan = packet_in.lon_plan;
        packet1.height_plan = packet_in.height_plan;
        packet1.remain_time_total = packet_in.remain_time_total;
        packet1.remain_time_next_waypoint = packet_in.remain_time_next_waypoint;
        packet1.v_e = packet_in.v_e;
        packet1.v_n = packet_in.v_n;
        packet1.v_u = packet_in.v_u;
        packet1.velocity = packet_in.velocity;
        packet1.mean_speed_next_waypoint = packet_in.mean_speed_next_waypoint;
        packet1.strike_target_x = packet_in.strike_target_x;
        packet1.strike_target_y = packet_in.strike_target_y;
        packet1.ammunition_id = packet_in.ammunition_id;
        packet1.task_phase_flag = packet_in.task_phase_flag;
        packet1.strike_call_flag = packet_in.strike_call_flag;
        packet1.response_call_flag = packet_in.response_call_flag;
        packet1.replan_flag = packet_in.replan_flag;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VISUAL_INERTIAL_NAVIGATION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VISUAL_INERTIAL_NAVIGATION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_visual_inertial_navigation_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_visual_inertial_navigation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_visual_inertial_navigation_pack(system_id, component_id, &msg , packet1.ammunition_id , packet1.time_msec , packet1.lat , packet1.lon , packet1.height , packet1.roll_speed , packet1.pitch_speed , packet1.yaw_speed , packet1.roll , packet1.pitch , packet1.yaw , packet1.v_e , packet1.v_n , packet1.v_u , packet1.velocity , packet1.ax , packet1.ay , packet1.az , packet1.task_phase_flag , packet1.lat_target , packet1.lon_target , packet1.height_target , packet1.strike_call_flag , packet1.response_call_flag , packet1.replan_flag , packet1.lat_plan , packet1.lon_plan , packet1.height_plan , packet1.remain_time_total , packet1.remain_time_next_waypoint , packet1.mean_speed_next_waypoint , packet1.strike_target_x , packet1.strike_target_y );
    mavlink_msg_visual_inertial_navigation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_visual_inertial_navigation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ammunition_id , packet1.time_msec , packet1.lat , packet1.lon , packet1.height , packet1.roll_speed , packet1.pitch_speed , packet1.yaw_speed , packet1.roll , packet1.pitch , packet1.yaw , packet1.v_e , packet1.v_n , packet1.v_u , packet1.velocity , packet1.ax , packet1.ay , packet1.az , packet1.task_phase_flag , packet1.lat_target , packet1.lon_target , packet1.height_target , packet1.strike_call_flag , packet1.response_call_flag , packet1.replan_flag , packet1.lat_plan , packet1.lon_plan , packet1.height_plan , packet1.remain_time_total , packet1.remain_time_next_waypoint , packet1.mean_speed_next_waypoint , packet1.strike_target_x , packet1.strike_target_y );
    mavlink_msg_visual_inertial_navigation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_visual_inertial_navigation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_visual_inertial_navigation_send(MAVLINK_COMM_1 , packet1.ammunition_id , packet1.time_msec , packet1.lat , packet1.lon , packet1.height , packet1.roll_speed , packet1.pitch_speed , packet1.yaw_speed , packet1.roll , packet1.pitch , packet1.yaw , packet1.v_e , packet1.v_n , packet1.v_u , packet1.velocity , packet1.ax , packet1.ay , packet1.az , packet1.task_phase_flag , packet1.lat_target , packet1.lon_target , packet1.height_target , packet1.strike_call_flag , packet1.response_call_flag , packet1.replan_flag , packet1.lat_plan , packet1.lon_plan , packet1.height_plan , packet1.remain_time_total , packet1.remain_time_next_waypoint , packet1.mean_speed_next_waypoint , packet1.strike_target_x , packet1.strike_target_y );
    mavlink_msg_visual_inertial_navigation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("VISUAL_INERTIAL_NAVIGATION") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_VISUAL_INERTIAL_NAVIGATION) != NULL);
#endif
}
...
static void mavlink_test_flow_angle(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FLOW_ANGLE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_flow_angle_t packet_in = {
        93372036854775807ULL,963497880,963498088
    };
    mavlink_flow_angle_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.timestamp = packet_in.timestamp;
        packet1.angle_attack = packet_in.angle_attack;
        packet1.angle_sideslip = packet_in.angle_sideslip;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FLOW_ANGLE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FLOW_ANGLE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flow_angle_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_flow_angle_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flow_angle_pack(system_id, component_id, &msg , packet1.timestamp , packet1.angle_attack , packet1.angle_sideslip );
    mavlink_msg_flow_angle_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flow_angle_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.angle_attack , packet1.angle_sideslip );
    mavlink_msg_flow_angle_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_flow_angle_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flow_angle_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.angle_attack , packet1.angle_sideslip );
    mavlink_msg_flow_angle_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("FLOW_ANGLE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_FLOW_ANGLE) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_external_control(system_id, component_id, last_msg);
    mavlink_test_swarm_position(system_id, component_id, last_msg);
    mavlink_test_video_raw_data(system_id, component_id, last_msg);
    mavlink_test_visual_inertial_navigation(system_id, component_id, last_msg);
    ...
    mavlink_test_flow_angle(system_id, component_id, last_msg);
